...
promptTemplate = "You will talk to the human conversing with you and provide meaningful answers as they ask questions.Be very logically and technically oriented. Use the following pieces of MemoryContext to answer the question at the end. Also remember Conversation History is listing all the previous questions that user asked and the answer that bot provided.---ConversationHistory: {history}---MemoryContext: {context}---Human: {question} Bot:"
